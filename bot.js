...
client.on('interactionCreate', async (interaction) => {
    ...
    //WEBSITE COMMAND
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(`Here's the statistics over 7 days`)
            .setAuthor({name: 'Kryptokrona', iconURL: 'https://letshash.it/static/coins/xkr.png', url: 'https://kryptokrona.org'})
            .setThumbnail('https://letshash.it/static/coins/xkr.png')
            .addFields(
                {name: '\u200B', value: '\u200B'},
                ...
                {name: 'Bounce rate', value: `${huginBounceRate}%`, inline: true},
                {name: '\u200B', value: '\u200B'},
            )
            .setFooter({text: 'Data provided by Plausible'})
            .setTimestamp()
